package com.example.shinelon.wanandroid.view
...
class FlowLayout : ViewGroup {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        for (i in 0 until childCount) {
            ...
            if (cwSum > originWidth) { //大于允许的宽度，则该换行
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        for (i in 0 until childCount) {
            ...
            if (cwSum > measuredWidth) { //超过换行，其他思路同上
                //cwSum -= child.measuredWidth + params.leftMargin + params.rightMargin
                sHeight += cHeight
                ...
                right = child.measuredWidth + params.leftMargin
     ...
     */
    private class FlowLayoutParams : MarginLayoutParams {
